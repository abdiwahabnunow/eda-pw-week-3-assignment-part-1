...
let favoriteFoods = [`Ugali`, `Pasta`,`Chapati`, `Bariis`];
console.log(`My favoriteFoods are: ` , favoriteFoods);
...
console.log(`The number of my favourite food is :` ,numberOfFoods);
...
console.log('the second animal in the array is:',secondAnimal);
...
console.log('last animal in the array is:',lastAnimal);
